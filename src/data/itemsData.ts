...
export const items: Item[] = [
    ...
    {id: 1305, models: [], name: '量子芯片', icon: 'quantum-processor', grid: [1, 6, 10]},
    {id: 1302, models: [], name: '微晶元件', icon: 'micro-component', grid: [1, 4, 5]},
    {id: 1304, models: [], name: '位面过滤器', icon: 'plane-filter', grid: [1, 6, 9]},
    {id: 1402, models: [], name: '粒子宽带', icon: 'particle-wide-band', grid: [1, 5, 10]},
    ...
    {id: 1403, models: [], name: '湮灭约束球', icon: 'fusion-capacitor', grid: [1, 5, 8]},
    {id: 1405, models: [], name: '推进器2', icon: 'fuel-thruster', grid: [1, 3, 11]},
    {id: 1406, models: [], name: '加力推进器', icon: 'ion-thruster', grid: [1, 4, 11]},
    {id: 5001, models: [47], name: '物流运输机', icon: 'logistic-drone', grid: [1, 5, 11]},
    {id: 5002, models: [48], name: '星际物流运输船', icon: 'logistic-vessel', grid: [1, 6, 11]},
    ...
    {id: 2106, models: [121], name: '储液罐', icon: 'storage-tank', grid: [2, 2, 9]},
    ...
    {id: 2207, models: [46], name: '蓄电器（满）', icon: 'accumulator-full', grid: [2, 4, 11]},
    {id: 2311, models: [72], name: '电磁轨道弹射器', icon: 'em-rail-ejector', grid: [2, 3, 10]},
    {id: 2208, models: [73], name: '射线接收站', icon: 'ray-receiver', grid: [2, 1, 10]},
    {id: 2312, models: [74], name: '垂直发射井', icon: 'vertical-launching-silo', grid: [2, 3, 11]},
    {id: 2209, models: [45], name: '能量枢纽', icon: 'energy-exchanger', grid: [2, 1, 9]},
    {id: 2310, models: [69], name: '微型粒子对撞机', icon: 'hadron-collider', grid: [2, 3, 9]},
    ...
    {id: 2901, models: [70], name: '矩阵研究站', icon: 'lab', grid: [2, 4, 9]},
